...
- bins_below targets downside price coverage from candidate bin_step + positive volatility, clamped to [minBinsBelow,maxBinsBelow]. Volatility must be a positive number; 0/unknown means skip.
